...
pub fn llm_repository_router() -> ApiRouter {
    ApiRouter::new()
        .api_route(
            "/llm-repositories",
            get_with(list_repositories, list_repositories_docs),
        )
        .api_route(
            "/llm-repositories",
            post_with(create_repository, create_repository_docs),
        )
        .api_route(
        ...
        .api_route(
            "/llm-repositories/{repository_id}",
            post_with(update_repository, update_repository_docs),
        )
        .api_route(
            "/llm-repositories/{repository_id}",
            aide::axum::routing::delete_with(delete_repository, delete_repository_docs),
        )
}
