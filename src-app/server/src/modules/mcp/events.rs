...
impl McpServerEvent {
    ...
    pub fn system_server_created(server_id: Uuid) -> crate::core::AppEvent {
        crate::core::AppEvent::McpServer(McpServerEvent::SystemServerCreated {
            server_id,
        })
    }
    ...
    pub fn user_server_created(server_id: Uuid, user_id: Uuid) -> crate::core::AppEvent {
        crate::core::AppEvent::McpServer(McpServerEvent::UserServerCreated {
            server_id,
            user_id,
        })
    }
    ...
    pub fn system_server_updated(server_id: Uuid) -> crate::core::AppEvent {
        crate::core::AppEvent::McpServer(McpServerEvent::SystemServerUpdated {
            server_id,
        })
    }
    ...
    pub fn user_server_updated(server_id: Uuid, user_id: Uuid) -> crate::core::AppEvent {
        crate::core::AppEvent::McpServer(McpServerEvent::UserServerUpdated {
            server_id,
            user_id,
        })
    }
    ...
    pub fn group_assignment_changed(server_id: Uuid) -> crate::core::AppEvent {
        crate::core::AppEvent::McpServer(McpServerEvent::GroupAssignmentChanged {
            server_id,
        })
    }
}
