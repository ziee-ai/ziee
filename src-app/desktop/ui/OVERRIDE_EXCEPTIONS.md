...
- SHADOW-EXCEPTION: api-client/apiEndpoints.ts — a GENERATED file: the desktop `--generate-openapi` binary writes the desktop-specific ApiEndpoints map here (split out of types.ts by the api-client codegen). Machine-generated, not a hand-written override; same category as api-client/types.ts [approved: merge-fp-agentcore 2026-07-22]
- SHADOW-EXCEPTION: api-client/permissions.ts — a GENERATED file: the desktop `--generate-openapi` binary writes the desktop Permissions enum here (split out of types.ts). Machine-generated, same category as api-client/types.ts [approved: merge-fp-agentcore 2026-07-22]
- SHADOW-EXCEPTION: api-client/permissionDescriptions.ts — a GENERATED file: the desktop `--generate-openapi` binary writes the desktop permission-descriptions map here (split out of types.ts). Machine-generated, same category as api-client/types.ts [approved: merge-fp-agentcore 2026-07-22]
