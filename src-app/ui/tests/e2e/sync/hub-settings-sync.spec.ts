// ⚠️ PIN CHECK (2026-07): main's seed index.json is hub_version "2.0.0"; the
// ziee-ai/hub repo has releases v0.0.{1,2,3}-alpha. Before trusting this green,
// run once and confirm device B's initial VersionPicker tag matches the pin
// below (update if the seeded/latest release differs). Recovered from an old
// worktree; fills the sole missing sync-entity e2e (every other entity has one).
