import type { FileViewerModule, FileViewerEntry, FileSupportEntry } from '../types/viewer'

type ViewerModule = { viewers: FileViewerModule[] }

const modules = import.meta.glob<ViewerModule>('../viewers/*/module.tsx', { eager: true })
