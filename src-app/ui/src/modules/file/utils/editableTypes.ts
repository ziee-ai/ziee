...
export type EditableKind = 'markdown' | 'code' | null

/**
 * Which canvas editor (if any) can edit this file. markdown → Plate WYSIWYG;
 * code → CodeMirror; everything else (pdf/image/office/binary) is view-only.
 * Single source used by both the FilePanel edit toggle and the edit body.
 */
