    ...
    >
            ...
            <div key={t.key} className="relative inline-flex items-center">
              ...
              {showClose && (
                <button
                  ...
                  className="absolute right-1.5 top-1/2 inline-flex size-4 -translate-y-1/2 items-center justify-center opacity-60 hover:opacity-100"
                >
      ...
      {editable && !hideAdd && (
        <button
          ...
          disabled={s.disabled}
          onClick={add}
          className="ml-1 inline-flex size-7 items-center justify-center disabled:opacity-50"
        >
