/**
 * Shard 1 seeded-surface entries (parallel gap grind).
 *
 * OWNED BY SHARD 1 ONLY. Add `SeededSurfaceEntry` objects for your assigned
 * gaps here. Import helpers from './helpers'. Prefix every slug with
 * `seeded-s1-` so slugs never collide across shards. Do NOT edit
...
// import { lazyNamed, lazyProps, lazyCompose, holdPatch, whenTrue } from './helpers'
