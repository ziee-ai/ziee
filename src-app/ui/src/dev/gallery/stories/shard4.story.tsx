/**
 * Shard 4 kit/component stories (parallel gap grind). OWNED BY SHARD 4 ONLY.
 ...
 * data-testid with `s4-` so they never collide. Do NOT edit stories/index.ts
 * (integrator-owned aggregator) — it already imports this file.
 */
import type { GalleryStory } from '../story'

export const shard4Stories: GalleryStory[] = [
  // add stories here
]
