...
//
// 366 surfaces carry renderable-state signals; 2154 signals total.
...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/scheduler/components/ScheduledTaskCard": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "task.paused_reason === 'completed'", line: 414 },
      { kind: "branch", condition: "task.paused_reason", line: 419 },
      { kind: "branch", condition: "expanded", line: 443 },
      { kind: "branch", condition: "!runs", line: 445 },
      { kind: "empty", condition: "total === 0", line: 447 },
      { kind: "branch", condition: "total > perPage", line: 463 },
    ],
  },
  "modules/scheduler/components/ScheduledTaskFormDrawer": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "targetKind === 'prompt'", line: 458 },
      { kind: "branch", condition: "hasDeclaredInputs", line: 480 },
      { kind: "branch", condition: "form.formState.errors.schedule?.message", line: 532 },
      { kind: "branch", condition: "testing", line: 562 },
      { kind: "branch", condition: "testResult", line: 567 },
    ],
  },
