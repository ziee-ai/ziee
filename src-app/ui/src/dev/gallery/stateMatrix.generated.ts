...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "components/ui/kit/table": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "!active", line: 144 },
      { kind: "branch", condition: "view.sort!.dir === 'asc'", line: 145 },
      { kind: "branch", condition: "meta.sortable", line: 148 },
      { kind: "branch", condition: "props.filterable", line: 216 },
      { kind: "branch", condition: "props.columnChooser && hideable.length > 0", line: 228 },
      { kind: "branch", condition: "target.tagName === 'INPUT' || target.tagName === 'TEXTAREA'", line: 298 },
      { kind: "branch", condition: "!tsv", line: 300 },
      { kind: "branch", condition: "showVirtual", line: 311 },
      { kind: "branch", condition: "hasToolbar", line: 322 },
      { kind: "branch", condition: "idx == null || idx < 0 || idx >= rows.length", line: 353 },
      { kind: "branch", condition: "caption != null", line: 363 },
      { kind: "branch", condition: "resizableTable", line: 364 },
      { kind: "branch", condition: "meta.resizable", line: 384 },
      { kind: "branch", condition: "busy", line: 391 },
      { kind: "empty", condition: "rows.length === 0", line: 399 },
      { kind: "branch", condition: "meta.resizable", line: 510 },
      { kind: "branch", condition: "mode === 'none'", line: 560 },
      { kind: "branch", condition: "(props.selectionMode ?? 'none') === 'none'", line: 565 },
      { kind: "branch", condition: "!selectionActive(props, col)", line: 572 },
    ],
  },
