...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/chat/components/MessageList": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "indexOfMessageId(arrRef.current, id) < 0", line: 281 },
      { kind: "branch", condition: "!el", line: 290 },
      { kind: "empty", condition: "count === 0", line: 297 },
      { kind: "branch", condition: "!el", line: 315 },
      { kind: "branch", condition: "!item", line: 318 },
      { kind: "branch", condition: "!msg", line: 320 },
      { kind: "branch", condition: "!c", line: 326 },
      { kind: "branch", condition: "virtualize", line: 331 },
      { kind: "branch", condition: "idx < 0", line: 333 },
      { kind: "branch", condition: "el && !anchorRestoreNeeded(el.scrollTop, target)", line: 345 },
      { kind: "branch", condition: "!c", line: 351 },
      { kind: "branch", condition: "newTop == null", line: 353 },
      { kind: "loading", condition: "!loading && count === 0", line: 362 },
      { kind: "branch", condition: "loadingOlder", line: 388 },
      { kind: "branch", condition: "virtualize", line: 398 },
      { kind: "branch", condition: "!msg", line: 413 },
      { kind: "loading", condition: "(loading || isStreaming)", line: 457 },
    ],
  },
