...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "components/ui/kit/table": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "props.columnChooser && hideable.length > 0", line: 239 },
      { kind: "branch", condition: "props.toolbarExtra", line: 267 },
      { kind: "branch", condition: "target.tagName === 'INPUT' || target.tagName === 'TEXTAREA'", line: 320 },
      { kind: "branch", condition: "!tsv", line: 322 },
      { kind: "branch", condition: "showVirtual", line: 333 },
      { kind: "branch", condition: "hasToolbar", line: 344 },
      { kind: "branch", condition: "idx == null || idx < 0 || idx >= rows.length", line: 375 },
      { kind: "branch", condition: "caption != null", line: 385 },
      { kind: "branch", condition: "resizableTable", line: 386 },
      { kind: "branch", condition: "meta.resizable", line: 406 },
      { kind: "branch", condition: "busy", line: 413 },
      { kind: "empty", condition: "rows.length === 0", line: 421 },
      { kind: "branch", condition: "meta.resizable", line: 532 },
      { kind: "branch", condition: "mode === 'none'", line: 582 },
      { kind: "branch", condition: "(props.selectionMode ?? 'none') === 'none'", line: 587 },
      { kind: "branch", condition: "!selectionActive(props, col)", line: 594 },
    ],
  },
