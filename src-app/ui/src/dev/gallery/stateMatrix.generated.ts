...
//
// 318 surfaces carry renderable-state signals; 1788 signals total.
...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/llm-provider/components/llm-models/AddRemoteLlmModelDrawer": {
    ...
    requiredStates: ["open"],
    signals: [
      { kind: "branch", condition: "!m", line: 90 },
      { kind: "branch", condition: "!providerId", line: 105 },
      { kind: "branch", condition: "!name", line: 107 },
      { kind: "overlay", condition: "<Drawer open>", line: 153 },
      { kind: "branch", condition: "canCreate", line: 161 },
      { kind: "branch", condition: "!useCustomId", line: 178 },
      { kind: "branch", condition: "notes && notes.length > 0", line: 209 },
    ],
  },
