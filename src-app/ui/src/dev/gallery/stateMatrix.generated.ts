...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/chat/pages/ConversationPage": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "panes.length < 2", line: 99 },
      { kind: "branch", condition: "!focusedConvId || focusedConvId === conversationId", line: 100 },
      { kind: "branch", condition: "panes.length >= 2", line: 105 },
      { kind: "branch", condition: "!conversationId", line: 176 },
      { kind: "branch", condition: "kind === 'pane'", line: 196 },
      { kind: "branch", condition: "!pane", line: 197 },
      { kind: "branch", condition: "kind !== 'conversation' || !conversationId", line: 206 },
      { kind: "branch", condition: "!droppedId", line: 208 },
      { kind: "branch", condition: "pane", line: 212 },
      { kind: "branch", condition: "!droppedOnLeft", line: 236 },
      { kind: "branch", condition: "!sentinel", line: 383 },
      { kind: "branch", condition: "!el", line: 403 },
      { kind: "branch", condition: "!nativeScroll", line: 418 },
      { kind: "branch", condition: "y < 0 || y > maxY", line: 427 },
      { kind: "branch", condition: "maxY - y <= 8", line: 431 },
      { kind: "branch", condition: "Math.abs(dy) < 6", line: 437 },
      { kind: "branch", condition: "!chat.$.conversation", line: 457 },
      { kind: "branch", condition: "pane && pane.paneId !== Stores.SplitView.$.focusedPaneId", line: 461 },
      { kind: "branch", condition: "!conversationId", line: 503 },
      { kind: "branch", condition: "didSeedApprovalsRef.current", line: 559 },
      { kind: "branch", condition: "conversation?.id !== conversationId", line: 560 },
      { kind: "branch", condition: "!hasNewApproval", line: 595 },
      { kind: "branch", condition: "pendingAnchorRef.current || hasMoreAfter || conversation?.id !== conversationId || initialScrollConvIdRef.current !== conversationId", line: 599 },
      { kind: "branch", condition: "!sentinel", line: 627 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 631 },
      { kind: "branch", condition: "!chat.$.hasMoreBefore || chat.$.loadingOlder", line: 634 },
      { kind: "branch", condition: "!sentinel", line: 669 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 673 },
      { kind: "branch", condition: "!chat.$.hasMoreAfter || chat.$.isStreaming", line: 674 },
      { kind: "loading", condition: "!pending", line: 689 },
      { kind: "loading", condition: "!currentFirst || currentFirst === pending.prevFirstId", line: 692 },
      { kind: "branch", condition: "!conversation?.id", line: 701 },
      { kind: "branch", condition: "!m", line: 705 },
      { kind: "branch", condition: "!found || chat.$.conversation?.id !== conversation.id", line: 708 },
      { kind: "loading", condition: "loading && !conversation", line: 739 },
      { kind: "branch", condition: "pane && !conversationId && !conversation", line: 751 },
      { kind: "loading", condition: "!loading && !conversation", line: 758 },
      { kind: "error", condition: "error", line: 761 },
      { kind: "branch", condition: "!isPopoutWindow", line: 806 },
      { kind: "branch", condition: "pane", line: 829 },
      { kind: "error", condition: "error", line: 896 },
      { kind: "branch", condition: "dropZone", line: 922 },
      { kind: "branch", condition: "dropZone === z", line: 951 },
      { kind: "branch", condition: "nativeScroll && !composerHidden", line: 1047 },
    ],
  },
