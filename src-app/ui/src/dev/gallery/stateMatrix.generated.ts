...
//
// 366 surfaces carry renderable-state signals; 2152 signals total.
...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/chat/core/utils/useStreamdownComponents": {
    ...
    signals: [
      ...
      { kind: "empty", condition: "verdict === 'empty'", line: 170 },
      { kind: "branch", condition: "verdict === 'allowed'", line: 171 },
    ],
  },
  ...
  "modules/chat/pages/ConversationPage": {
    ...
    requiredStates: ["delayed","error"],
    signals: [
      { kind: "branch", condition: "!sentinel", line: 149 },
      { kind: "branch", condition: "!el", line: 169 },
      { kind: "branch", condition: "!nativeScroll", line: 184 },
      { kind: "branch", condition: "y < 0 || y > maxY", line: 193 },
      { kind: "branch", condition: "maxY - y <= 8", line: 197 },
  ...
  "modules/file/chat-extension/components/FilePasteHandler": {
    ...
    requiredStates: ["empty"],
    signals: [
      { kind: "branch", condition: "!el", line: 34 },
      { kind: "branch", condition: "!canUploadRef.current", line: 37 },
      { kind: "branch", condition: "!dt", line: 39 },
      { kind: "empty", condition: "collected.length === 0", line: 58 },
    ],
  },
  ...
  "modules/file/chat-extension/components/FileUploadArea": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "!canUploadRef.current", line: 58 },
      { kind: "empty", condition: "dropped.length === 0", line: 64 },
      { kind: "branch", condition: "dragging && host", line: 101 },
    ],
  },
  "modules/file/chat-extension/components/FileUploadButton": {
    ...
    requiredStates: [],
    signals: [
      { kind: "branch", condition: "!canUpload", line: 20 },
    ],
  },
  ...
  "modules/file/chat-extension/components/InlineFilePreview": {
    ...
    requiredStates: [],
    signals: [
      { kind: "branch", condition: "view.seen", line: 106 },
      { kind: "branch", condition: "typeof IntersectionObserver === 'undefined'", line: 107 },
      { kind: "branch", condition: "!el", line: 112 },
      { kind: "branch", condition: "!file", line: 155 },
      { kind: "branch", condition: "!start", line: 192 },
      { kind: "branch", condition: "dragStart.current == null", line: 196 },
      { kind: "branch", condition: "next == null", line: 220 },
      { kind: "branch", condition: "label", line: 256 },
      { kind: "branch", condition: "displaySize !== undefined", line: 257 },
      { kind: "branch", condition: "HeaderActions", line: 261 },
      { kind: "branch", condition: "file", line: 262 },
      { kind: "branch", condition: "file", line: 263 },
      { kind: "branch", condition: "hasBody", line: 275 },
      { kind: "branch", condition: "collapsed", line: 285 },
      { kind: "branch", condition: "showBodyRegion", line: 297 },
      { kind: "branch", condition: "view.seen && Body", line: 299 },
    ],
  },
  ...
  "modules/file/chat-extension/extension": {
    ...
    signals: [
      { kind: "branch", condition: "!data.file_id", line: 35 },
      { kind: "branch", condition: "data.source?.type !== 'file'", line: 56 },
      { kind: "branch", condition: "!fileData?.file_id || !fileData?.filename", line: 110 },
      { kind: "panel", condition: "registerPanelRenderer('file')", line: 151 },
      { kind: "branch", condition: "!file", line: 156 },
      { kind: "branch", condition: "!fileStore", line: 181 },
      { kind: "empty", condition: "stubs.length === 0", line: 279 },
  ...
  "modules/mcp/chat-extension/extension": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "!mcpStore", line: 426 },
      { kind: "branch", condition: "!streamingMessage", line: 853 },
      { kind: "branch", condition: "!toolUseId", line: 865 },
    ],
  },
  ...
  "modules/scheduler/components/ScheduledTaskCard": {
    ...
    requiredStates: ["empty","error","open"],
    signals: [
      { kind: "branch", condition: "open", line: 119 },
      { kind: "branch", condition: "badge", line: 126 },
      { kind: "branch", condition: "preview", line: 132 },
      { kind: "branch", condition: "open", line: 180 },
      { kind: "error", condition: "run.status === 'failed' && run.error_message", line: 186 },
      { kind: "branch", condition: "skip", line: 192 },
      { kind: "error", condition: "!preview && run.status !== 'failed'", line: 200 },
      { kind: "branch", condition: "task.paused_reason === 'completed'", line: 286 },
      { kind: "branch", condition: "task.paused_reason", line: 291 },
      { kind: "branch", condition: "task.target_kind === 'prompt'", line: 320 },
      { kind: "overlay", condition: "<Confirm open>", line: 373 },
      { kind: "branch", condition: "expanded", line: 405 },
      { kind: "branch", condition: "!runs", line: 407 },
      { kind: "empty", condition: "total === 0", line: 409 },
      { kind: "branch", condition: "total > perPage", line: 425 },
    ],
  },
  "modules/scheduler/components/ScheduledTaskFormDrawer": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "!values.model_id.trim()", line: 330 },
      { kind: "branch", condition: "values.target_kind === 'workflow' && !values.workflow_id.trim()", line: 334 },
      { kind: "branch", condition: "values.target_kind === 'prompt' && !values.prompt.trim()", line: 338 },
      { kind: "branch", condition: "dyn", line: 343 },
      { kind: "overlay", condition: "<Drawer open>", line: 377 },
      { kind: "branch", condition: "canUse", line: 402 },
      { kind: "branch", condition: "targetKind === 'prompt'", line: 449 },
      { kind: "branch", condition: "hasDeclaredInputs", line: 471 },
      { kind: "branch", condition: "testing", line: 545 },
      { kind: "branch", condition: "testResult", line: 550 },
    ],
  },
  "modules/scheduler/pages/ScheduledTasksPage": {
    ...
    requiredStates: ["delayed","error"],
    signals: [
      { kind: "branch", condition: "tasks.length > 0", line: 80 },
      { kind: "branch", condition: "hasMore", line: 117 },
      { kind: "loading", condition: "loading", line: 128 },
