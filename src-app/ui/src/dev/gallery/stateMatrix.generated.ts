...
//
// 323 surfaces carry renderable-state signals; 1808 signals total.
...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/mcp/chat-extension/components/ElicitationFormContent": {
    ...
    requiredStates: [],
    signals: [
      { kind: "branch", condition: "isSelectField", line: 216 },
      { kind: "branch", condition: "isMultiSelect", line: 218 },
      { kind: "branch", condition: "fieldSchema.type === 'boolean'", line: 256 },
      { kind: "branch", condition: "fieldSchema.type === 'number' || fieldSchema.type === 'integer'", line: 270 },
      { kind: "branch", condition: "fieldSchema.type === 'string' && fieldSchema.format === 'date'", line: 295 },
      { kind: "branch", condition: "fieldSchema.type === 'string' && fieldSchema.format === 'date-time'", line: 315 },
      { kind: "branch", condition: "fieldSchema.format === 'password'", line: 337 },
      { kind: "branch", condition: "status === 'accepted'", line: 436 },
      { kind: "branch", condition: "items.length > 0", line: 469 },
      { kind: "branch", condition: "status === 'declined'", line: 484 },
      { kind: "branch", condition: "status === 'cancelled'", line: 507 },
    ],
  },
