...
//
// 325 surfaces carry renderable-state signals; 1890 signals total.
...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "components/ui/kit/table": {
    ...
    requiredStates: ["empty"],
    signals: [
      { kind: "branch", condition: "v == null || typeof v === 'boolean'", line: 120 },
      { kind: "branch", condition: "!active", line: 152 },
      { kind: "branch", condition: "view.sort!.dir === 'asc'", line: 153 },
      { kind: "branch", condition: "meta.sortable", line: 156 },
      { kind: "branch", condition: "props.filterable", line: 230 },
      { kind: "branch", condition: "props.columnChooser && hideable.length > 0", line: 246 },
      { kind: "branch", condition: "props.toolbarExtra", line: 274 },
      { kind: "branch", condition: "target.tagName === 'INPUT' || target.tagName === 'TEXTAREA'", line: 327 },
      { kind: "branch", condition: "!tsv", line: 329 },
      { kind: "branch", condition: "showVirtual", line: 340 },
      { kind: "branch", condition: "hasToolbar", line: 351 },
      { kind: "branch", condition: "idx == null || idx < 0 || idx >= rows.length", line: 382 },
      { kind: "branch", condition: "caption != null", line: 392 },
      { kind: "branch", condition: "resizableTable", line: 393 },
      { kind: "branch", condition: "meta.resizable", line: 413 },
      { kind: "branch", condition: "busy", line: 420 },
      { kind: "empty", condition: "rows.length === 0", line: 428 },
      { kind: "branch", condition: "meta.resizable", line: 539 },
      { kind: "branch", condition: "mode === 'none'", line: 589 },
      { kind: "branch", condition: "(props.selectionMode ?? 'none') === 'none'", line: 594 },
      { kind: "branch", condition: "!selectionActive(props, col)", line: 601 },
    ],
  },
  ...
  "modules/chat/pages/ConversationPage": {
    ...
    requiredStates: ["delayed","error"],
    signals: [
      { kind: "branch", condition: "!sentinel", line: 160 },
      { kind: "branch", condition: "!el", line: 180 },
      { kind: "branch", condition: "!nativeScroll", line: 195 },
      { kind: "branch", condition: "y < 0 || y > maxY", line: 204 },
      { kind: "branch", condition: "maxY - y <= 8", line: 208 },
      { kind: "branch", condition: "Math.abs(dy) < 6", line: 214 },
      { kind: "branch", condition: "!nativeScroll || !composerHidden", line: 232 },
      { kind: "branch", condition: "!Stores.Chat.$.conversation", line: 261 },
      { kind: "branch", condition: "!conversationId", line: 303 },
      { kind: "branch", condition: "!sentinel", line: 351 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 355 },
      { kind: "branch", condition: "!Stores.Chat.$.hasMoreBefore || Stores.Chat.$.loadingOlder", line: 358 },
      { kind: "branch", condition: "!sentinel", line: 393 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 397 },
      { kind: "branch", condition: "!Stores.Chat.$.hasMoreAfter || Stores.Chat.$.isStreaming", line: 398 },
      { kind: "loading", condition: "!pending", line: 413 },
      { kind: "loading", condition: "!currentFirst || currentFirst === pending.prevFirstId", line: 416 },
      { kind: "branch", condition: "!conversation?.id", line: 425 },
      { kind: "branch", condition: "!m", line: 429 },
      { kind: "branch", condition: "!found || Stores.Chat.$.conversation?.id !== conversation.id", line: 432 },
      { kind: "loading", condition: "loading && !conversation", line: 452 },
      { kind: "loading", condition: "!loading && !conversation", line: 461 },
      { kind: "error", condition: "error", line: 464 },
      { kind: "error", condition: "error", line: 521 },
      { kind: "branch", condition: "nativeScroll && !composerParked", line: 620 },
    ],
  },
  ...
  "modules/file/components/FilePanel": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "isViewingOld", line: 151 },
      { kind: "branch", condition: "oldVersionText === null", line: 153 },
      { kind: "branch", condition: "tooLarge", line: 168 },
      { kind: "branch", condition: "Body", line: 192 },
    ],
  },
  ...
  "modules/layouts/app-layout/components/LeftSidebar": {
    ...
    requiredStates: [],
    signals: [
      { kind: "branch", condition: "!item", line: 163 },
      { kind: "branch", condition: "primaryItems.length > 0", line: 184 },
      { kind: "branch", condition: "navigationItems.length > 0", line: 199 },
      { kind: "branch", condition: "!isIconOnly", line: 221 },
      { kind: "branch", condition: "isIconOnly", line: 234 },
      { kind: "branch", condition: "toolsItems.length > 0", line: 237 },
      { kind: "branch", condition: "!isIconOnly && bottomWidgets.length > 0", line: 257 },
      { kind: "branch", condition: "footerWidgets.length > 0", line: 272 },
    ],
  },
