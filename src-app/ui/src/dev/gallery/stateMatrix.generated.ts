...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/chat/pages/ConversationPage": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "!sentinel", line: 244 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 248 },
      { kind: "branch", condition: "!Stores.Chat.$.hasMoreBefore || Stores.Chat.$.loadingOlder", line: 251 },
      { kind: "branch", condition: "!sentinel", line: 286 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 290 },
      { kind: "branch", condition: "!Stores.Chat.$.hasMoreAfter || Stores.Chat.$.isStreaming", line: 291 },
      { kind: "loading", condition: "!pending", line: 305 },
      { kind: "loading", condition: "!currentFirst || currentFirst === pending.prevFirstId", line: 308 },
      { kind: "branch", condition: "!c || !v", line: 314 },
      { kind: "branch", condition: "newTop == null", line: 316 },
      { kind: "branch", condition: "!conversation?.id", line: 361 },
      { kind: "branch", condition: "!m", line: 365 },
      { kind: "branch", condition: "!found || Stores.Chat.$.conversation?.id !== conversation.id", line: 368 },
      { kind: "loading", condition: "loading && !conversation", line: 389 },
      { kind: "loading", condition: "!loading && !conversation", line: 398 },
      { kind: "error", condition: "error", line: 401 },
      { kind: "error", condition: "error", line: 458 },
    ],
  },
