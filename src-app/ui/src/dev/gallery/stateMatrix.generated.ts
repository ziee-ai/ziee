...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/mcp/chat-extension/components/ElicitationFormContent": {
    ...
    requiredStates: [],
    signals: [
      { kind: "branch", condition: "isSelectField", line: 214 },
      { kind: "branch", condition: "isMultiSelect", line: 216 },
      { kind: "branch", condition: "fieldSchema.type === 'boolean'", line: 254 },
      { kind: "branch", condition: "fieldSchema.type === 'number' || fieldSchema.type === 'integer'", line: 268 },
      { kind: "branch", condition: "fieldSchema.type === 'string' && fieldSchema.format === 'date'", line: 293 },
      { kind: "branch", condition: "fieldSchema.type === 'string' && fieldSchema.format === 'date-time'", line: 313 },
      { kind: "branch", condition: "fieldSchema.format === 'password'", line: 335 },
      { kind: "branch", condition: "status === 'accepted'", line: 463 },
      { kind: "branch", condition: "items.length > 0", line: 492 },
      { kind: "branch", condition: "status === 'declined'", line: 506 },
      { kind: "branch", condition: "status === 'cancelled'", line: 526 },
    ],
  },
