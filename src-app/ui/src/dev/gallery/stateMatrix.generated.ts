...
//
// 312 surfaces carry renderable-state signals; 1718 signals total.
...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "components/ui/kit/tree": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "virtualStyle", line: 278 },
      { kind: "branch", condition: "!virtual", line: 283 },
    ],
  },
  ...
  "modules/file/chat-extension/components/InlineFilePreview": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "canInline && Body", line: 142 },
      { kind: "branch", condition: "collapsed", line: 148 },
      { kind: "branch", condition: "label", line: 167 },
      { kind: "branch", condition: "displaySize !== undefined", line: 168 },
      { kind: "branch", condition: "HeaderActions", line: 171 },
      { kind: "branch", condition: "file", line: 174 },
      { kind: "branch", condition: "file", line: 187 },
      { kind: "branch", condition: "showBody && Body", line: 224 },
    ],
  },
  ...
  "modules/mcp/chat-extension/extension": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "!toolUseData.id", line: 144 },
      { kind: "branch", condition: "toolCall", line: 151 },
      { kind: "branch", condition: "mcpServerParenLabel(server?.display_name)", line: 177 },
      { kind: "branch", condition: "toolResultData", line: 182 },
      { kind: "branch", condition: "hasDetails", line: 190 },
      { kind: "branch", condition: "isExpanded", line: 201 },
      { kind: "branch", condition: "!!toolUseData.input", line: 203 },
      { kind: "branch", condition: "toolResultData", line: 211 },
      { kind: "branch", condition: "toolResultData.is_error", line: 214 },
      { kind: "branch", condition: "isExpanded", line: 295 },
      { kind: "branch", condition: "!run || countToolUses(run) < 2", line: 320 },
      { kind: "branch", condition: "!mcpStore", line: 350 },
      { kind: "branch", condition: "!streamingMessage", line: 687 },
      { kind: "branch", condition: "!toolUseId", line: 702 },
    ],
  },
