...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/llm-provider/components/LlmModelsSection": {
    ...
    requiredStates: ["delayed","empty"],
    signals: [
      { kind: "branch", condition: "!currentProvider", line: 45 },
      { kind: "branch", condition: "!currentProvider", line: 103 },
      { kind: "branch", condition: "!currentProvider || currentProvider.provider_type !== 'local'", line: 117 },
      { kind: "branch", condition: "!currentProvider", line: 141 },
      { kind: "branch", condition: "!currentProvider", line: 156 },
      { kind: "branch", condition: "!currentProvider", line: 163 },
      { kind: "branch", condition: "!currentProvider", line: 252 },
      { kind: "branch", condition: "!canCreateModels", line: 253 },
      { kind: "branch", condition: "currentProvider.provider_type === 'local'", line: 255 },
      { kind: "branch", condition: "!currentProvider || currentProvider.provider_type === 'local'", line: 318 },
      { kind: "branch", condition: "!canEditModels", line: 321 },
      { kind: "branch", condition: "!currentProvider", line: 349 },
      { kind: "loading", condition: "loading", line: 355 },
      { kind: "empty", condition: "llmModels.length === 0", line: 357 },
      { kind: "branch", condition: "llmModel.is_deprecated", line: 373 },
      { kind: "branch", condition: "llmModel.is_active && llmModel.port", line: 394 },
      { kind: "branch", condition: "llmModel.description", line: 406 },
      { kind: "branch", condition: "llmModel.capabilities", line: 411 },
      { kind: "branch", condition: "llmModel.capabilities.vision", line: 413 },
      { kind: "branch", condition: "llmModel.capabilities.audio", line: 418 },
      { kind: "branch", condition: "llmModel.capabilities.tools", line: 423 },
      { kind: "branch", condition: "llmModel.capabilities.code_interpreter", line: 428 },
      { kind: "branch", condition: "llmModel.capabilities.chat", line: 433 },
      { kind: "branch", condition: "llmModel.capabilities.text_embedding", line: 438 },
      { kind: "branch", condition: "llmModel.capabilities.image_generator", line: 443 },
      { kind: "branch", condition: "index < llmModels.length - 1", line: 453 },
    ],
  },
