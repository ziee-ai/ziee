...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/chat/components/MessageList": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "!import.meta.env.DEV", line: 252 },
      { kind: "branch", condition: "indexOfMessageId(arrRef.current, id) < 0", line: 326 },
      { kind: "branch", condition: "!el", line: 335 },
      { kind: "empty", condition: "count === 0", line: 342 },
      { kind: "branch", condition: "!el", line: 360 },
      { kind: "branch", condition: "!item", line: 363 },
      { kind: "branch", condition: "!msg", line: 365 },
      { kind: "branch", condition: "!c", line: 371 },
      { kind: "branch", condition: "virtualize", line: 376 },
      { kind: "branch", condition: "idx < 0", line: 378 },
      { kind: "branch", condition: "el && !anchorRestoreNeeded(el.scrollTop, target)", line: 390 },
      { kind: "branch", condition: "!c", line: 396 },
      { kind: "branch", condition: "newTop == null", line: 398 },
      { kind: "loading", condition: "!loading && count === 0", line: 407 },
      { kind: "branch", condition: "loadingOlder", line: 433 },
      { kind: "branch", condition: "virtualize", line: 443 },
      { kind: "branch", condition: "!msg", line: 458 },
      { kind: "loading", condition: "(loading || isStreaming)", line: 502 },
    ],
  },
  ...
  "modules/file/chat-extension/components/InlineFilePreview": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "!start", line: 185 },
      { kind: "branch", condition: "dragStart.current == null", line: 189 },
      { kind: "branch", condition: "next == null", line: 205 },
      { kind: "branch", condition: "label", line: 241 },
      { kind: "branch", condition: "displaySize !== undefined", line: 242 },
      { kind: "branch", condition: "HeaderActions", line: 246 },
      { kind: "branch", condition: "file", line: 247 },
      { kind: "branch", condition: "file", line: 248 },
      { kind: "branch", condition: "hasBody", line: 260 },
      { kind: "branch", condition: "collapsed", line: 270 },
      { kind: "branch", condition: "showBodyRegion", line: 282 },
      { kind: "branch", condition: "view.seen && Body", line: 284 },
    ],
  },
