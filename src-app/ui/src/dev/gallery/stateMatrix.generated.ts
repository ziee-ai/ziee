...
//
// 361 surfaces carry renderable-state signals; 2069 signals total.
...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/mcp/chat-extension/extension": {
    ...
    requiredStates: ["error"],
    signals: [
      { kind: "branch", condition: "toolCall.status === 'pending_approval'", line: 39 },
      { kind: "branch", condition: "serverLabel", line: 55 },
      { kind: "error", condition: "(toolCall.status === 'completed' || toolCall.status === 'error')", line: 63 },
      { kind: "branch", condition: "toolCall.status === 'started' && toolCall.progress", line: 81 },
      { kind: "branch", condition: "toolCall.progress.message", line: 83 },
      { kind: "branch", condition: "isExpanded", line: 106 },
      { kind: "branch", condition: "toolCall.input !== undefined", line: 108 },
      { kind: "branch", condition: "toolCall.result !== undefined", line: 117 },
      { kind: "error", condition: "toolCall.error", line: 126 },
      { kind: "branch", condition: "!toolUseData.id", line: 157 },
      { kind: "branch", condition: "toolCall", line: 164 },
      { kind: "branch", condition: "mcpServerParenLabel(server?.display_name)", line: 190 },
      { kind: "branch", condition: "toolResultData", line: 195 },
      { kind: "branch", condition: "hasDetails", line: 203 },
      { kind: "branch", condition: "isExpanded", line: 214 },
      { kind: "branch", condition: "!!toolUseData.input", line: 216 },
      { kind: "branch", condition: "toolResultData", line: 224 },
      { kind: "branch", condition: "toolResultData.is_error", line: 227 },
      { kind: "branch", condition: "isExpanded", line: 329 },
      { kind: "branch", condition: "!run || countToolUses(run) < 2", line: 354 },
      { kind: "branch", condition: "!mcpStore", line: 384 },
      { kind: "branch", condition: "!streamingMessage", line: 811 },
      { kind: "branch", condition: "!toolUseId", line: 823 },
    ],
  },
