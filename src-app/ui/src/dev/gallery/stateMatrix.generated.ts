...
//
// 367 surfaces carry renderable-state signals; 2177 signals total.
...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/chat/pages/ConversationPage": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "sv.panes.length < 2", line: 64 },
      { kind: "branch", condition: "focused?.conversationId === conversationId", line: 66 },
      { kind: "branch", condition: "panes.length >= 2", line: 70 },
      { kind: "branch", condition: "!pane || !isWorkspaceDrag(e.dataTransfer)", line: 99 },
      { kind: "branch", condition: "!pane", line: 104 },
      { kind: "branch", condition: "!sentinel", line: 273 },
      { kind: "branch", condition: "!el", line: 293 },
      { kind: "branch", condition: "!nativeScroll", line: 308 },
      { kind: "branch", condition: "y < 0 || y > maxY", line: 317 },
      { kind: "branch", condition: "maxY - y <= 8", line: 321 },
      { kind: "branch", condition: "Math.abs(dy) < 6", line: 327 },
      { kind: "branch", condition: "!chat.$.conversation", line: 347 },
      { kind: "branch", condition: "!conversationId", line: 389 },
      { kind: "branch", condition: "didSeedApprovalsRef.current", line: 445 },
      { kind: "branch", condition: "conversation?.id !== conversationId", line: 446 },
      { kind: "branch", condition: "!hasNewApproval", line: 481 },
      { kind: "branch", condition: "pendingAnchorRef.current || hasMoreAfter || conversation?.id !== conversationId || initialScrollConvIdRef.current !== conversationId", line: 485 },
      { kind: "branch", condition: "!sentinel", line: 513 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 517 },
      { kind: "branch", condition: "!chat.$.hasMoreBefore || chat.$.loadingOlder", line: 520 },
      { kind: "branch", condition: "!sentinel", line: 555 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 559 },
      { kind: "branch", condition: "!chat.$.hasMoreAfter || chat.$.isStreaming", line: 560 },
      { kind: "loading", condition: "!pending", line: 575 },
      { kind: "loading", condition: "!currentFirst || currentFirst === pending.prevFirstId", line: 578 },
      { kind: "branch", condition: "!conversation?.id", line: 587 },
      { kind: "branch", condition: "!m", line: 591 },
      { kind: "branch", condition: "!found || chat.$.conversation?.id !== conversation.id", line: 594 },
      { kind: "loading", condition: "loading && !conversation", line: 625 },
      { kind: "branch", condition: "pane && !conversationId && !conversation", line: 637 },
      { kind: "loading", condition: "!loading && !conversation", line: 644 },
      { kind: "error", condition: "error", line: 647 },
      { kind: "branch", condition: "!isPopoutWindow", line: 692 },
      { kind: "branch", condition: "pane", line: 715 },
      { kind: "error", condition: "error", line: 767 },
      { kind: "branch", condition: "nativeScroll && !composerHidden", line: 866 },
    ],
  },
