...
//
// 323 surfaces carry renderable-state signals; 1834 signals total.
...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "components/ui/kit/table": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "props.filterable", line: 224 },
      { kind: "branch", condition: "props.columnChooser && hideable.length > 0", line: 236 },
      { kind: "branch", condition: "props.toolbarExtra", line: 264 },
      { kind: "branch", condition: "target.tagName === 'INPUT' || target.tagName === 'TEXTAREA'", line: 317 },
      { kind: "branch", condition: "!tsv", line: 319 },
      { kind: "branch", condition: "showVirtual", line: 330 },
      { kind: "branch", condition: "hasToolbar", line: 341 },
      { kind: "branch", condition: "idx == null || idx < 0 || idx >= rows.length", line: 372 },
      { kind: "branch", condition: "caption != null", line: 382 },
      { kind: "branch", condition: "resizableTable", line: 383 },
      { kind: "branch", condition: "meta.resizable", line: 403 },
      { kind: "branch", condition: "busy", line: 410 },
      { kind: "empty", condition: "rows.length === 0", line: 418 },
      { kind: "branch", condition: "meta.resizable", line: 529 },
      { kind: "branch", condition: "mode === 'none'", line: 579 },
      { kind: "branch", condition: "(props.selectionMode ?? 'none') === 'none'", line: 584 },
      { kind: "branch", condition: "!selectionActive(props, col)", line: 591 },
    ],
  },
  ...
  "modules/chat/components/ChatMessage": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "isUser", line: 215 },
    ],
  },
  ...
  "modules/chat/components/ConversationFindBar": {
    ...
    requiredStates: ["delayed","empty"],
    signals: [
      { kind: "branch", condition: "!match", line: 63 },
      { kind: "branch", condition: "!ok", line: 68 },
      { kind: "branch", condition: "!open", line: 87 },
      { kind: "branch", condition: "!conversationId || term === ''", line: 92 },
      { kind: "branch", condition: "cancelled || gen !== searchGenRef.current", line: 110 },
      { kind: "branch", condition: "!open", line: 145 },
      { kind: "branch", condition: "!open", line: 180 },
      { kind: "empty", condition: "total === 0", line: 183 },
      { kind: "branch", condition: "matches.length > 0", line: 287 },
      { kind: "loading", condition: "loading", line: 327 },
    ],
  },
  ...
  "modules/chat/components/MessageList": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "loadingOlder", line: 45 },
      { kind: "loading", condition: "(loading || isStreaming)", line: 71 },
    ],
  },
  ...
  "modules/chat/pages/ConversationPage": {
    ...
    requiredStates: ["delayed","error"],
    signals: [
      { kind: "branch", condition: "!sentinel", line: 136 },
      { kind: "branch", condition: "!Stores.Chat.$.conversation", line: 157 },
      { kind: "branch", condition: "!conversationId", line: 199 },
      { kind: "branch", condition: "!sentinel", line: 238 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 242 },
      { kind: "branch", condition: "!Stores.Chat.$.hasMoreBefore || Stores.Chat.$.loadingOlder", line: 245 },
      { kind: "branch", condition: "!sentinel", line: 280 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 284 },
      { kind: "branch", condition: "!Stores.Chat.$.hasMoreAfter || Stores.Chat.$.isStreaming", line: 285 },
      { kind: "loading", condition: "!pending", line: 299 },
      { kind: "loading", condition: "!currentFirst || currentFirst === pending.prevFirstId", line: 302 },
      { kind: "branch", condition: "!c || !v", line: 308 },
      { kind: "branch", condition: "newTop == null", line: 310 },
      { kind: "branch", condition: "!conversation?.id", line: 355 },
      { kind: "branch", condition: "!m", line: 359 },
      { kind: "branch", condition: "!found || Stores.Chat.$.conversation?.id !== conversation.id", line: 362 },
      { kind: "loading", condition: "loading && !conversation", line: 383 },
      { kind: "loading", condition: "!loading && !conversation", line: 392 },
      { kind: "error", condition: "error", line: 395 },
      { kind: "error", condition: "error", line: 452 },
    ],
  },
