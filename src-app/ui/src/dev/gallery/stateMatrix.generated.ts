...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "components/ui/kit/table": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "caption != null", line: 398 },
      { kind: "branch", condition: "resizableTable", line: 399 },
      { kind: "branch", condition: "meta.resizable", line: 419 },
      { kind: "branch", condition: "busy", line: 426 },
      { kind: "empty", condition: "rows.length === 0", line: 434 },
      { kind: "branch", condition: "meta.resizable", line: 550 },
      { kind: "branch", condition: "mode === 'none'", line: 600 },
      { kind: "branch", condition: "(props.selectionMode ?? 'none') === 'none'", line: 605 },
      { kind: "branch", condition: "!selectionActive(props, col)", line: 612 },
    ],
  },
