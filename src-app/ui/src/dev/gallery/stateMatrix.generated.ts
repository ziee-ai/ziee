...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/file/chat-extension/components/InlineFilePreview": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "file", line: 166 },
      { kind: "branch", condition: "file", line: 169 },
      { kind: "branch", condition: "canInline && Body", line: 185 },
      { kind: "branch", condition: "collapsed", line: 191 },
      { kind: "branch", condition: "showBody && Body", line: 209 },
    ],
  },
  ...
  "modules/mcp/chat-extension/components/AskUserWizardContent": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "step > 0", line: 418 },
      { kind: "branch", condition: "isLast", line: 430 },
      { kind: "branch", condition: "total > 1", line: 461 },
      { kind: "branch", condition: "current && isChoice && currentSchema.title", line: 485 },
      { kind: "branch", condition: "current && isChoice && currentSchema.description", line: 490 },
      { kind: "branch", condition: "current", line: 495 },
      { kind: "branch", condition: "isChoice", line: 496 },
    ],
  },
