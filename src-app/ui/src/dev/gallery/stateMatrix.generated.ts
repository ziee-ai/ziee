...
//
// 367 surfaces carry renderable-state signals; 2184 signals total.
...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/chat/components/ConversationCard": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "conversation.message_count > 0", line: 150 },
      { kind: "branch", condition: "canDelete && !isInSelectionMode", line: 188 },
      { kind: "overlay", condition: "<Confirm open>", line: 212 },
      { kind: "branch", condition: "onSelect", line: 230 },
    ],
  },
  ...
  "modules/chat/components/SplitChatView": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "!drag.current", line: 111 },
    ],
  },
  ...
  "modules/chat/pages/ConversationPage": {
    ...
    requiredStates: ["delayed","error"],
    signals: [
      { kind: "branch", condition: "!conversationId", line: 72 },
      { kind: "branch", condition: "sv.panes.length < 2", line: 74 },
      { kind: "branch", condition: "focused?.conversationId === conversationId", line: 76 },
      { kind: "branch", condition: "panes.length >= 2", line: 80 },
      { kind: "branch", condition: "!pane || dragKind(e.dataTransfer) !== 'pane'", line: 117 },
      { kind: "branch", condition: "!pane", line: 122 },
      { kind: "branch", condition: "dragKind(e.dataTransfer) !== 'pane'", line: 124 },
      { kind: "branch", condition: "!conversationId || dragKind(e.dataTransfer) !== 'conversation'", line: 152 },
      { kind: "branch", condition: "!conversationId || dragKind(e.dataTransfer) !== 'conversation'", line: 163 },
      { kind: "branch", condition: "!droppedId", line: 165 },
      { kind: "branch", condition: "pane", line: 169 },
      { kind: "branch", condition: "!droppedOnLeft", line: 193 },
      { kind: "branch", condition: "!sentinel", line: 340 },
      { kind: "branch", condition: "!el", line: 360 },
      { kind: "branch", condition: "!nativeScroll", line: 375 },
      { kind: "branch", condition: "y < 0 || y > maxY", line: 384 },
      { kind: "branch", condition: "maxY - y <= 8", line: 388 },
      { kind: "branch", condition: "Math.abs(dy) < 6", line: 394 },
      { kind: "branch", condition: "!chat.$.conversation", line: 414 },
      { kind: "branch", condition: "pane && pane.paneId !== Stores.SplitView.$.focusedPaneId", line: 418 },
      { kind: "branch", condition: "!conversationId", line: 460 },
      { kind: "branch", condition: "didSeedApprovalsRef.current", line: 516 },
      { kind: "branch", condition: "conversation?.id !== conversationId", line: 517 },
      { kind: "branch", condition: "!hasNewApproval", line: 552 },
      { kind: "branch", condition: "pendingAnchorRef.current || hasMoreAfter || conversation?.id !== conversationId || initialScrollConvIdRef.current !== conversationId", line: 556 },
      { kind: "branch", condition: "!sentinel", line: 584 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 588 },
      { kind: "branch", condition: "!chat.$.hasMoreBefore || chat.$.loadingOlder", line: 591 },
      { kind: "branch", condition: "!sentinel", line: 626 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 630 },
      { kind: "branch", condition: "!chat.$.hasMoreAfter || chat.$.isStreaming", line: 631 },
      { kind: "loading", condition: "!pending", line: 646 },
      { kind: "loading", condition: "!currentFirst || currentFirst === pending.prevFirstId", line: 649 },
      { kind: "branch", condition: "!conversation?.id", line: 658 },
      { kind: "branch", condition: "!m", line: 662 },
      { kind: "branch", condition: "!found || chat.$.conversation?.id !== conversation.id", line: 665 },
      { kind: "loading", condition: "loading && !conversation", line: 696 },
      { kind: "branch", condition: "pane && !conversationId && !conversation", line: 708 },
      { kind: "loading", condition: "!loading && !conversation", line: 715 },
      { kind: "error", condition: "error", line: 718 },
      { kind: "branch", condition: "!isPopoutWindow", line: 763 },
      { kind: "branch", condition: "pane", line: 786 },
      { kind: "error", condition: "error", line: 849 },
      { kind: "branch", condition: "dropZone", line: 875 },
      { kind: "branch", condition: "dropZone === z", line: 904 },
      { kind: "branch", condition: "nativeScroll && !composerHidden", line: 1000 },
    ],
  },
  "modules/chat/widgets/RecentConversationsWidget": {
    ...
    signals: [
      { kind: "branch", condition: "!(e.metaKey || e.ctrlKey || e.button === 1)", line: 55 },
      { kind: "branch", condition: "!c", line: 61 },
      { kind: "loading", condition: "loading && !isInitialized", line: 86 },
      { kind: "loading", condition: "!loading && recentConversations.length === 0", line: 97 },
      { kind: "branch", condition: "!c", line: 174 },
      { kind: "branch", condition: "active?.closest('[role=\"menu\"]')", line: 179 },
      { kind: "overlay", condition: "<Dropdown open>", line: 286 },
      { kind: "branch", condition: "!open && keepMenuOpen", line: 293 },
    ],
  },
