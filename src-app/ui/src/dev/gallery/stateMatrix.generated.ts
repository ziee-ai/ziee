...
//
// 367 surfaces carry renderable-state signals; 2173 signals total.
...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/chat/pages/ConversationPage": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "!sentinel", line: 265 },
      { kind: "branch", condition: "!el", line: 285 },
      { kind: "branch", condition: "!nativeScroll", line: 300 },
      { kind: "branch", condition: "y < 0 || y > maxY", line: 309 },
      { kind: "branch", condition: "maxY - y <= 8", line: 313 },
      { kind: "branch", condition: "Math.abs(dy) < 6", line: 319 },
      { kind: "branch", condition: "!chat.$.conversation", line: 339 },
      { kind: "branch", condition: "!conversationId", line: 381 },
      { kind: "branch", condition: "!hasNewApproval", line: 461 },
      { kind: "branch", condition: "pendingAnchorRef.current || hasMoreAfter || conversation?.id !== conversationId || initialScrollConvIdRef.current !== conversationId", line: 465 },
      { kind: "branch", condition: "!sentinel", line: 493 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 497 },
      { kind: "branch", condition: "!chat.$.hasMoreBefore || chat.$.loadingOlder", line: 500 },
      { kind: "branch", condition: "!sentinel", line: 535 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 539 },
      { kind: "branch", condition: "!chat.$.hasMoreAfter || chat.$.isStreaming", line: 540 },
      { kind: "loading", condition: "!pending", line: 555 },
      { kind: "loading", condition: "!currentFirst || currentFirst === pending.prevFirstId", line: 558 },
      { kind: "branch", condition: "!conversation?.id", line: 567 },
      { kind: "branch", condition: "!m", line: 571 },
      { kind: "branch", condition: "!found || chat.$.conversation?.id !== conversation.id", line: 574 },
      { kind: "loading", condition: "loading && !conversation", line: 605 },
      { kind: "branch", condition: "pane && !conversationId && !conversation", line: 617 },
      { kind: "loading", condition: "!loading && !conversation", line: 624 },
      { kind: "error", condition: "error", line: 627 },
      { kind: "branch", condition: "pane", line: 692 },
      { kind: "error", condition: "error", line: 744 },
      { kind: "branch", condition: "nativeScroll && !composerHidden", line: 843 },
    ],
  },
  ...
  "modules/knowledge-base/chat-extension/components/KbMenuItem": {
    ...
    requiredStates: ["empty"],
    signals: [
      { kind: "branch", condition: "!canUse", line: 38 },
      { kind: "empty", condition: "kbs.length === 0", line: 56 },
      { kind: "branch", condition: "kbs.length > 6", line: 75 },
      { kind: "branch", condition: "status", line: 109 },
      { kind: "empty", condition: "filtered.length === 0", line: 116 },
    ],
  },
  ...
  "modules/knowledge-base/chat-extension/components/KbStatusRow": {
    ...
    requiredStates: ["empty"],
    signals: [
      { kind: "empty", condition: "!canUse || (visibleIds.length === 0 && inheritedOnly.length === 0)", line: 34 },
    ],
  },
  ...
  "modules/mcp/chat-extension/extension": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "!streamingMessage", line: 865 },
      { kind: "branch", condition: "!toolUseId", line: 877 },
    ],
  },
  "modules/mcp/components/McpConfigModal": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "!isProjectScope", line: 384 },
      { kind: "empty", condition: "enabledServers.length === 0", line: 426 },
      { kind: "branch", condition: "isMobile", line: 552 },
      { kind: "overlay", condition: "<Drawer open>", line: 553 },
      { kind: "overlay", condition: "<Dialog open>", line: 565 },
    ],
  },
