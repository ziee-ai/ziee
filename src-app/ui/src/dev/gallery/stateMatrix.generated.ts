...
//
// 367 surfaces carry renderable-state signals; 2182 signals total.
...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/chat/components/TitleEditor": {
    ...
    requiredStates: [],
    signals: [
      { kind: "branch", condition: "isEditing", line: 87 },
      { kind: "branch", condition: "showBackButton", line: 133 },
    ],
  },
  ...
  "modules/chat/pages/ConversationPage": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "!sentinel", line: 316 },
      { kind: "branch", condition: "!el", line: 336 },
      { kind: "branch", condition: "!nativeScroll", line: 351 },
      { kind: "branch", condition: "y < 0 || y > maxY", line: 360 },
      { kind: "branch", condition: "maxY - y <= 8", line: 364 },
      { kind: "branch", condition: "Math.abs(dy) < 6", line: 370 },
      { kind: "branch", condition: "!chat.$.conversation", line: 390 },
      { kind: "branch", condition: "!conversationId", line: 432 },
      { kind: "branch", condition: "didSeedApprovalsRef.current", line: 488 },
      { kind: "branch", condition: "conversation?.id !== conversationId", line: 489 },
      { kind: "branch", condition: "!hasNewApproval", line: 524 },
      { kind: "branch", condition: "pendingAnchorRef.current || hasMoreAfter || conversation?.id !== conversationId || initialScrollConvIdRef.current !== conversationId", line: 528 },
      { kind: "branch", condition: "!sentinel", line: 556 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 560 },
      { kind: "branch", condition: "!chat.$.hasMoreBefore || chat.$.loadingOlder", line: 563 },
      { kind: "branch", condition: "!sentinel", line: 598 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 602 },
      { kind: "branch", condition: "!chat.$.hasMoreAfter || chat.$.isStreaming", line: 603 },
      { kind: "loading", condition: "!pending", line: 618 },
      { kind: "loading", condition: "!currentFirst || currentFirst === pending.prevFirstId", line: 621 },
      { kind: "branch", condition: "!conversation?.id", line: 630 },
      { kind: "branch", condition: "!m", line: 634 },
      { kind: "branch", condition: "!found || chat.$.conversation?.id !== conversation.id", line: 637 },
      { kind: "loading", condition: "loading && !conversation", line: 668 },
      { kind: "branch", condition: "pane && !conversationId && !conversation", line: 680 },
      { kind: "loading", condition: "!loading && !conversation", line: 687 },
      { kind: "error", condition: "error", line: 690 },
      { kind: "branch", condition: "!isPopoutWindow", line: 735 },
      { kind: "branch", condition: "pane", line: 758 },
      { kind: "error", condition: "error", line: 821 },
      { kind: "branch", condition: "!pane && singleDropZone", line: 843 },
      { kind: "branch", condition: "singleDropZone === z", line: 855 },
      { kind: "branch", condition: "nativeScroll && !composerHidden", line: 952 },
    ],
  },
