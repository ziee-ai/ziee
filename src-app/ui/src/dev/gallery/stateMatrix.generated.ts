...
//
// 367 surfaces carry renderable-state signals; 2175 signals total.
...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/assistant/chat-extension/components/AssistantMenuItem": {
    ...
    requiredStates: ["empty"],
    signals: [
      { kind: "branch", condition: "selectedAssistantId", line: 35 },
      { kind: "empty", condition: "availableAssistants.length === 0", line: 44 },
      { kind: "branch", condition: "dividerAfter", line: 134 },
    ],
  },
  "modules/assistant/chat-extension/components/AssistantSelector": {
    ...
    requiredStates: ["empty"],
    signals: [
      { kind: "empty", condition: "availableAssistants.length === 0", line: 34 },
    ],
  },
  "modules/assistant/chat-extension/components/AssistantStatusChip": {
    ...
    requiredStates: [],
    signals: [
      { kind: "branch", condition: "!selectedAssistantId", line: 20 },
      { kind: "branch", condition: "!assistant", line: 25 },
    ],
  },
  ...
  "modules/chat/components/ChatMessage": {
    ...
    requiredStates: ["empty"],
    signals: [
      { kind: "branch", condition: "isStreaming || wasStreamingRef.current || isActiveMatch", line: 55 },
      { kind: "empty", condition: "contents.length === 0 && !showEmptyCompletionNotice", line: 77 },
      { kind: "branch", condition: "attachmentBlocks.length > 0", line: 167 },
      { kind: "branch", condition: "bubbleBlocks.length > 0", line: 196 },
      { kind: "branch", condition: "offerCollapse", line: 222 },
      { kind: "branch", condition: "showEmptyCompletionNotice", line: 242 },
      { kind: "branch", condition: "isUser", line: 261 },
    ],
  },
  ...
  "modules/chat/components/ConversationCard": {
    ...
    requiredStates: ["open"],
    signals: [
      { kind: "branch", condition: "isInSelectionMode && onSelect", line: 60 },
      { kind: "branch", condition: "e && e.button === 2", line: 66 },
      { kind: "branch", condition: "conversation.message_count > 0", line: 140 },
      { kind: "branch", condition: "canDelete && !isInSelectionMode", line: 178 },
      { kind: "overlay", condition: "<Confirm open>", line: 202 },
      { kind: "branch", condition: "onSelect", line: 220 },
    ],
  },
  ...
  "modules/chat/components/MessageList": {
    ...
    requiredStates: ["delayed","empty"],
    signals: [
      { kind: "branch", condition: "!vw || vw <= 0", line: 117 },
      { kind: "branch", condition: "w <= 0", line: 119 },
      { kind: "branch", condition: "!el", line: 130 },
      { kind: "branch", condition: "inPlaceAnchorSignal.key != null && item.key === inPlaceAnchorSignal.key", line: 264 },
      { kind: "branch", condition: "!import.meta.env.DEV", line: 296 },
      { kind: "branch", condition: "indexOfMessageId(arrRef.current, id) < 0", line: 370 },
      { kind: "branch", condition: "!el", line: 379 },
      { kind: "empty", condition: "count === 0", line: 386 },
      { kind: "branch", condition: "!el", line: 404 },
      { kind: "branch", condition: "!item", line: 407 },
      { kind: "branch", condition: "!msg", line: 409 },
      { kind: "branch", condition: "!c", line: 415 },
      { kind: "branch", condition: "virtualize", line: 420 },
      { kind: "branch", condition: "idx < 0", line: 422 },
      { kind: "branch", condition: "el && !anchorRestoreNeeded(el.scrollTop, target)", line: 434 },
      { kind: "branch", condition: "!c", line: 449 },
      { kind: "branch", condition: "top == null", line: 452 },
      { kind: "loading", condition: "!loading && count === 0", line: 475 },
      { kind: "branch", condition: "loadingOlder", line: 501 },
      { kind: "branch", condition: "virtualize", line: 511 },
      { kind: "branch", condition: "!msg", line: 526 },
      { kind: "loading", condition: "(loading || isStreaming)", line: 582 },
    ],
  },
  ...
  "modules/chat/components/OpenInNewWindowAction": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "!popoutActionVisible(pane != null, isDesktop)", line: 38 },
    ],
  },
  ...
  "modules/chat/pages/ConversationPage": {
    ...
    requiredStates: ["delayed","error"],
    signals: [
      { kind: "branch", condition: "!conversationId", line: 61 },
      { kind: "branch", condition: "sv.panes.length < 2", line: 63 },
      { kind: "branch", condition: "focused?.conversationId === conversationId", line: 65 },
      { kind: "branch", condition: "panes.length >= 2", line: 69 },
      { kind: "branch", condition: "!pane || !isWorkspaceDrag(e.dataTransfer)", line: 94 },
      { kind: "branch", condition: "!pane", line: 99 },
      { kind: "branch", condition: "!sentinel", line: 268 },
      { kind: "branch", condition: "!el", line: 288 },
      { kind: "branch", condition: "!nativeScroll", line: 303 },
      { kind: "branch", condition: "y < 0 || y > maxY", line: 312 },
      { kind: "branch", condition: "maxY - y <= 8", line: 316 },
      { kind: "branch", condition: "Math.abs(dy) < 6", line: 322 },
      { kind: "branch", condition: "!chat.$.conversation", line: 342 },
      { kind: "branch", condition: "!conversationId", line: 384 },
      { kind: "branch", condition: "didSeedApprovalsRef.current", line: 440 },
      { kind: "branch", condition: "conversation?.id !== conversationId", line: 441 },
      { kind: "branch", condition: "!hasNewApproval", line: 476 },
      { kind: "branch", condition: "pendingAnchorRef.current || hasMoreAfter || conversation?.id !== conversationId || initialScrollConvIdRef.current !== conversationId", line: 480 },
      { kind: "branch", condition: "!sentinel", line: 508 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 512 },
      { kind: "branch", condition: "!chat.$.hasMoreBefore || chat.$.loadingOlder", line: 515 },
      { kind: "branch", condition: "!sentinel", line: 550 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 554 },
      { kind: "branch", condition: "!chat.$.hasMoreAfter || chat.$.isStreaming", line: 555 },
      { kind: "loading", condition: "!pending", line: 570 },
      { kind: "loading", condition: "!currentFirst || currentFirst === pending.prevFirstId", line: 573 },
      { kind: "branch", condition: "!conversation?.id", line: 582 },
      { kind: "branch", condition: "!m", line: 586 },
      { kind: "branch", condition: "!found || chat.$.conversation?.id !== conversation.id", line: 589 },
      { kind: "loading", condition: "loading && !conversation", line: 620 },
      { kind: "branch", condition: "pane && !conversationId && !conversation", line: 632 },
      { kind: "loading", condition: "!loading && !conversation", line: 639 },
      { kind: "error", condition: "error", line: 642 },
      { kind: "branch", condition: "pane", line: 707 },
      { kind: "error", condition: "error", line: 759 },
      { kind: "branch", condition: "nativeScroll && !composerHidden", line: 858 },
    ],
  },
  "modules/chat/widgets/RecentConversationsWidget": {
    ...
    signals: [
      { kind: "branch", condition: "!(e.metaKey || e.ctrlKey || e.button === 1)", line: 51 },
      { kind: "branch", condition: "!c", line: 57 },
      { kind: "loading", condition: "loading && !isInitialized", line: 82 },
      { kind: "loading", condition: "!loading && recentConversations.length === 0", line: 93 },
      { kind: "branch", condition: "!c", line: 169 },
      { kind: "branch", condition: "active?.closest('[role=\"menu\"]')", line: 174 },
      { kind: "overlay", condition: "<Dropdown open>", line: 281 },
      { kind: "branch", condition: "!open && keepMenuOpen", line: 288 },
    ],
  },
  ...
  "modules/file/components/CanvasSelectionPopover": {
    ...
    requiredStates: ["empty"],
    signals: [
      { kind: "empty", condition: "!s || s.rangeCount === 0 || !text || !container", line: 42 },
      { kind: "branch", condition: "!container.contains(range.commonAncestorContainer)", line: 48 },
      { kind: "branch", condition: "!sel", line: 64 },
      { kind: "branch", condition: "instruction == null || !instruction.trim()", line: 81 },
    ],
  },
  ...
  "modules/layouts/app-layout/AppLayout": {
    ...
    requiredStates: ["open"],
    signals: [
      { kind: "branch", condition: "prevXsRef.current === windowMinSize.sm", line: 205 },
      ...
      { kind: "branch", condition: "!windowMinSize.sm || !isSidebarCollapsed || e.touches.length !== 1", line: 289 },
      { kind: "branch", condition: "document.querySelector( '[data-slot=\"layout-drawer\"], [data-slot=\"dialog-content\"], [data-slot=\"sheet-content\"], [role=\"alertdialog\"]', )", line: 293 },
      { kind: "branch", condition: "scrollableX && el.scrollWidth > el.clientWidth + 1", line: 311 },
      { kind: "branch", condition: "!s", line: 318 },
      { kind: "branch", condition: "Math.abs(dx) < 10 && Math.abs(dy) < 10", line: 323 },
      { kind: "branch", condition: "Math.abs(dy) > Math.abs(dx) || dx < 0", line: 325 },
      { kind: "branch", condition: "!mainContentElement", line: 343 },
      { kind: "branch", condition: "!window.visualViewport", line: 382 },
      { kind: "branch", condition: "!window.visualViewport", line: 386 },
      { kind: "branch", condition: "windowMinSize.sm", line: 431 },
      { kind: "overlay", condition: "<Sheet open>", line: 432 },
      { kind: "branch", condition: "!windowMinSize.sm", line: 454 },
      { kind: "branch", condition: "!isSidebarCollapsed", line: 534 },
    ],
  },
  ...
  "modules/layouts/app-layout/components/LeftSidebar": {
    ...
    requiredStates: [],
    signals: [
      { kind: "branch", condition: "!item", line: 169 },
      { kind: "branch", condition: "primaryItems.length > 0", line: 190 },
      { kind: "branch", condition: "navigationItems.length > 0", line: 205 },
      { kind: "branch", condition: "!isIconOnly", line: 227 },
      { kind: "branch", condition: "isIconOnly", line: 240 },
  ...
  "modules/user-llm-providers/chat-extension/components/ModelSelector": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "pendingProviderForKey", line: 150 },
    ],
  },
...
export const SLOT_REGISTRATIONS: SlotRegistration[] = [
  { slot: "chatConversationHeaderTrailing", surface: "modules/chat/module", line: 119 },
  ...
  { slot: "sidebarContent", surface: "modules/chat/module", line: 104 },
]
