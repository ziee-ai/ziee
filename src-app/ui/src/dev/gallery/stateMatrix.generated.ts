...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/chat/pages/ConversationPage": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "!conversationId", line: 141 },
      { kind: "branch", condition: "kind === 'pane'", line: 161 },
      { kind: "branch", condition: "!pane", line: 162 },
      { kind: "branch", condition: "kind !== 'conversation' || !conversationId", line: 171 },
      { kind: "branch", condition: "!droppedId", line: 173 },
      { kind: "branch", condition: "pane", line: 177 },
      { kind: "branch", condition: "!droppedOnLeft", line: 201 },
      { kind: "branch", condition: "!sentinel", line: 348 },
      { kind: "branch", condition: "!el", line: 368 },
      { kind: "branch", condition: "!nativeScroll", line: 383 },
      { kind: "branch", condition: "y < 0 || y > maxY", line: 392 },
      { kind: "branch", condition: "maxY - y <= 8", line: 396 },
      { kind: "branch", condition: "Math.abs(dy) < 6", line: 402 },
      { kind: "branch", condition: "!chat.$.conversation", line: 422 },
      { kind: "branch", condition: "pane && pane.paneId !== Stores.SplitView.$.focusedPaneId", line: 426 },
      { kind: "branch", condition: "!conversationId", line: 468 },
      { kind: "branch", condition: "didSeedApprovalsRef.current", line: 524 },
      { kind: "branch", condition: "conversation?.id !== conversationId", line: 525 },
      { kind: "branch", condition: "!hasNewApproval", line: 560 },
      { kind: "branch", condition: "pendingAnchorRef.current || hasMoreAfter || conversation?.id !== conversationId || initialScrollConvIdRef.current !== conversationId", line: 564 },
      { kind: "branch", condition: "!sentinel", line: 592 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 596 },
      { kind: "branch", condition: "!chat.$.hasMoreBefore || chat.$.loadingOlder", line: 599 },
      { kind: "branch", condition: "!sentinel", line: 634 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 638 },
      { kind: "branch", condition: "!chat.$.hasMoreAfter || chat.$.isStreaming", line: 639 },
      { kind: "loading", condition: "!pending", line: 654 },
      { kind: "loading", condition: "!currentFirst || currentFirst === pending.prevFirstId", line: 657 },
      { kind: "branch", condition: "!conversation?.id", line: 666 },
      { kind: "branch", condition: "!m", line: 670 },
      { kind: "branch", condition: "!found || chat.$.conversation?.id !== conversation.id", line: 673 },
      { kind: "loading", condition: "loading && !conversation", line: 704 },
      { kind: "branch", condition: "pane && !conversationId && !conversation", line: 716 },
      { kind: "loading", condition: "!loading && !conversation", line: 723 },
      { kind: "error", condition: "error", line: 726 },
      { kind: "branch", condition: "!isPopoutWindow", line: 771 },
      { kind: "branch", condition: "pane", line: 794 },
      { kind: "error", condition: "error", line: 857 },
      { kind: "branch", condition: "dropZone", line: 883 },
      { kind: "branch", condition: "dropZone === z", line: 912 },
      { kind: "branch", condition: "nativeScroll && !composerHidden", line: 1008 },
    ],
  },
