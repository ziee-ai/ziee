...
//
// 367 surfaces carry renderable-state signals; 2183 signals total.
...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/chat/components/SplitChatView": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "!drag.current", line: 116 },
    ],
  },
  ...
  "modules/chat/pages/ConversationPage": {
    ...
    requiredStates: ["delayed","error"],
    signals: [
      { kind: "branch", condition: "!conversationId", line: 73 },
      { kind: "branch", condition: "sv.panes.length < 2", line: 75 },
      { kind: "branch", condition: "focused?.conversationId === conversationId", line: 77 },
      { kind: "branch", condition: "panes.length >= 2", line: 81 },
      { kind: "branch", condition: "!conversationId", line: 148 },
      { kind: "branch", condition: "kind === 'pane'", line: 168 },
      { kind: "branch", condition: "!pane", line: 169 },
      { kind: "branch", condition: "kind !== 'conversation' || !conversationId", line: 178 },
      { kind: "branch", condition: "!droppedId", line: 180 },
      { kind: "branch", condition: "pane", line: 184 },
      { kind: "branch", condition: "!droppedOnLeft", line: 208 },
      { kind: "branch", condition: "!sentinel", line: 355 },
      { kind: "branch", condition: "!el", line: 375 },
      { kind: "branch", condition: "!nativeScroll", line: 390 },
      { kind: "branch", condition: "y < 0 || y > maxY", line: 399 },
      { kind: "branch", condition: "maxY - y <= 8", line: 403 },
      { kind: "branch", condition: "Math.abs(dy) < 6", line: 409 },
      { kind: "branch", condition: "!chat.$.conversation", line: 429 },
      { kind: "branch", condition: "pane && pane.paneId !== Stores.SplitView.$.focusedPaneId", line: 433 },
      { kind: "branch", condition: "!conversationId", line: 475 },
      { kind: "branch", condition: "didSeedApprovalsRef.current", line: 531 },
      { kind: "branch", condition: "conversation?.id !== conversationId", line: 532 },
      { kind: "branch", condition: "!hasNewApproval", line: 567 },
      { kind: "branch", condition: "pendingAnchorRef.current || hasMoreAfter || conversation?.id !== conversationId || initialScrollConvIdRef.current !== conversationId", line: 571 },
      { kind: "branch", condition: "!sentinel", line: 599 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 603 },
      { kind: "branch", condition: "!chat.$.hasMoreBefore || chat.$.loadingOlder", line: 606 },
      { kind: "branch", condition: "!sentinel", line: 641 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 645 },
      { kind: "branch", condition: "!chat.$.hasMoreAfter || chat.$.isStreaming", line: 646 },
      { kind: "loading", condition: "!pending", line: 661 },
      { kind: "loading", condition: "!currentFirst || currentFirst === pending.prevFirstId", line: 664 },
      { kind: "branch", condition: "!conversation?.id", line: 673 },
      { kind: "branch", condition: "!m", line: 677 },
      { kind: "branch", condition: "!found || chat.$.conversation?.id !== conversation.id", line: 680 },
      { kind: "loading", condition: "loading && !conversation", line: 711 },
      { kind: "branch", condition: "pane && !conversationId && !conversation", line: 723 },
      { kind: "loading", condition: "!loading && !conversation", line: 730 },
      { kind: "error", condition: "error", line: 733 },
      { kind: "branch", condition: "!isPopoutWindow", line: 778 },
      { kind: "branch", condition: "pane", line: 801 },
      { kind: "error", condition: "error", line: 868 },
      { kind: "branch", condition: "dropZone", line: 894 },
      { kind: "branch", condition: "dropZone === z", line: 923 },
      { kind: "branch", condition: "nativeScroll && !composerHidden", line: 1019 },
    ],
  },
