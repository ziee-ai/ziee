...
//
// 361 surfaces carry renderable-state signals; 2074 signals total.
...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/chat/core/utils/useStreamdownComponents": {
    ...
    requiredStates: ["empty"],
    signals: [
      { kind: "branch", condition: "isFootnoteLabel(props.id)", line: 60 },
      { kind: "branch", condition: "(rest as Record<string, unknown>)['data-footnotes'] === undefined", line: 76 },
      { kind: "branch", condition: "className?.includes('data-footnote-backref') || (rest as Record<string, unknown>)['data-footnote-backref'] !== undefined", line: 92 },
      { kind: "branch", condition: "scopedHref?.startsWith('#')", line: 109 },
      { kind: "empty", condition: "verdict === 'empty'", line: 164 },
      { kind: "branch", condition: "verdict === 'allowed'", line: 165 },
    ],
  },
  ...
  "modules/llm-provider/components/llm-models/shared/LlmModelCapabilitiesSection": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "help", line: 147 },
      { kind: "branch", condition: "help", line: 194 },
    ],
  },
  ...
  "modules/mcp/chat-extension/components/ToolCallPendingApprovalContent": {
    ...
    requiredStates: [],
    signals: [
      { kind: "branch", condition: "typeof window === 'undefined'", line: 49 },
      { kind: "branch", condition: "!el", line: 51 },
      { kind: "branch", condition: "scrolledApprovals.has(toolCall.tool_use_id)", line: 53 },
      { kind: "branch", condition: "!isControlWrite", line: 228 },
      { kind: "branch", condition: "mcpServerParenLabel(toolCall.server)", line: 247 },
      { kind: "branch", condition: "toolCall.input !== undefined", line: 262 },
    ],
  },
  ...
  "modules/mcp/chat-extension/extension": {
    ...
    signals: [
      ...
      { kind: "branch", condition: "singleUse", line: 333 },
      { kind: "branch", condition: "singleServerLabel", line: 336 },
      { kind: "branch", condition: "isExpanded", line: 355 },
      { kind: "branch", condition: "!run || !shouldWrapRun(run)", line: 380 },
      { kind: "branch", condition: "!mcpStore", line: 413 },
      { kind: "branch", condition: "!streamingMessage", line: 840 },
      { kind: "branch", condition: "!toolUseId", line: 852 },
    ],
  },
