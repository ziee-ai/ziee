...
export const STATE_MATRIX: Record<string, SurfaceStateMatrix> = {
  ...
  "modules/chat/pages/ConversationPage": {
    ...
    requiredStates: ["delayed","error"],
    signals: [
      { kind: "branch", condition: "!conversationId", line: 71 },
      { kind: "branch", condition: "sv.panes.length < 2", line: 73 },
      { kind: "branch", condition: "focused?.conversationId === conversationId", line: 75 },
      { kind: "branch", condition: "panes.length >= 2", line: 79 },
      { kind: "branch", condition: "!pane || !isWorkspaceDrag(e.dataTransfer)", line: 112 },
      { kind: "branch", condition: "!pane", line: 117 },
      { kind: "branch", condition: "pane || !conversationId || dragKind(e.dataTransfer) !== 'conversation'", line: 153 },
      { kind: "branch", condition: "pane || !conversationId || dragKind(e.dataTransfer) !== 'conversation'", line: 164 },
      { kind: "branch", condition: "!droppedId", line: 166 },
      { kind: "branch", condition: "!droppedOnLeft", line: 181 },
      { kind: "branch", condition: "!sentinel", line: 328 },
      { kind: "branch", condition: "!el", line: 348 },
      { kind: "branch", condition: "!nativeScroll", line: 363 },
      { kind: "branch", condition: "y < 0 || y > maxY", line: 372 },
      { kind: "branch", condition: "maxY - y <= 8", line: 376 },
      { kind: "branch", condition: "Math.abs(dy) < 6", line: 382 },
      { kind: "branch", condition: "!chat.$.conversation", line: 402 },
      { kind: "branch", condition: "pane && pane.paneId !== Stores.SplitView.$.focusedPaneId", line: 406 },
      { kind: "branch", condition: "!conversationId", line: 448 },
      { kind: "branch", condition: "didSeedApprovalsRef.current", line: 504 },
      { kind: "branch", condition: "conversation?.id !== conversationId", line: 505 },
      { kind: "branch", condition: "!hasNewApproval", line: 540 },
      { kind: "branch", condition: "pendingAnchorRef.current || hasMoreAfter || conversation?.id !== conversationId || initialScrollConvIdRef.current !== conversationId", line: 544 },
      { kind: "branch", condition: "!sentinel", line: 572 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 576 },
      { kind: "branch", condition: "!chat.$.hasMoreBefore || chat.$.loadingOlder", line: 579 },
      { kind: "branch", condition: "!sentinel", line: 614 },
      { kind: "branch", condition: "!entries[0]?.isIntersecting", line: 618 },
      { kind: "branch", condition: "!chat.$.hasMoreAfter || chat.$.isStreaming", line: 619 },
      { kind: "loading", condition: "!pending", line: 634 },
      { kind: "loading", condition: "!currentFirst || currentFirst === pending.prevFirstId", line: 637 },
      { kind: "branch", condition: "!conversation?.id", line: 646 },
      { kind: "branch", condition: "!m", line: 650 },
      { kind: "branch", condition: "!found || chat.$.conversation?.id !== conversation.id", line: 653 },
      { kind: "loading", condition: "loading && !conversation", line: 684 },
      { kind: "branch", condition: "pane && !conversationId && !conversation", line: 696 },
      { kind: "loading", condition: "!loading && !conversation", line: 703 },
      { kind: "error", condition: "error", line: 706 },
      { kind: "branch", condition: "!isPopoutWindow", line: 751 },
      { kind: "branch", condition: "pane", line: 774 },
      { kind: "error", condition: "error", line: 837 },
      { kind: "branch", condition: "!pane && singleDropZone", line: 859 },
      { kind: "branch", condition: "singleDropZone === z", line: 871 },
      { kind: "branch", condition: "nativeScroll && !composerHidden", line: 968 },
    ],
  },
